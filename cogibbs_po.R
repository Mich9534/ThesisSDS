#--------------------------------------------------------------------
# MY IMPLEMENTATION OF COLLAPSED GIBBS SAMPLER USING A POISSON PRIOR
#--------------------------------------------------------------------

fcogibbs_po <- function(M, K_start, A, n, a, b, gamma_, logVn.Miller, z_start){
...
# fcogibbs_po(250, 9,A, n, a, b, gamma_, logVn.Miller)
